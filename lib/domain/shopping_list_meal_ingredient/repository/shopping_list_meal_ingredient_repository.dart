...
abstract class ShoppingListMealIngredientRepository {
  ...
  Future<Either<Failure, List<MealEntity>>> getUnsyncedShoppingListMealIngredient();
  Future<Either<Failure, void>> markShoppingListMealIngredientAsSynced(String mealId);
