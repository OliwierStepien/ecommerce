...
abstract class FriendRepository {
  ...
  // Nowe metody
  Future<Either<Failure, void>> sendFriendInvitation(String friendEmail);
  Future<Either<Failure, List<FriendInvitationEntity>>> getPendingInvitations();
  Future<Either<Failure, List<FriendInvitationEntity>>> getSentInvitations();
  Future<Either<Failure, void>> respondToInvitation(String invitationId, bool accept);
  Future<Either<Failure, int>> getPendingInvitationsCount();
}