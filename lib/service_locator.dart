...
Future<void> initializeDependencies() async {
  ...
  sl.registerLazySingleton<SendPasswordResetEmailUseCase>(() => SendPasswordResetEmailUseCase());
  ...
  sl.registerLazySingleton<GetMealByCategoryIdUseCase>(() => GetMealByCategoryIdUseCase());

  sl.registerLazySingleton<GetMealByTitleUseCase>(() => GetMealByTitleUseCase());

  sl.registerLazySingleton<AddOrRemoveFavoriteMealUseCase>(() => AddOrRemoveFavoriteMealUseCase());

  sl.registerLazySingleton<IsFavoriteUseCase>(() => IsFavoriteUseCase());
  
  sl.registerLazySingleton<GetFavoritesMealUseCase>(() => GetFavoritesMealUseCase());
}
